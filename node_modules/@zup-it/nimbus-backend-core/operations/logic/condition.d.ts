 ...
 */
export declare const condition: <WhenTrue extends ValidOperationAttribute, WhenFalse extends ValidOperationAttribute>(premise: Expression<boolean>, ifTrue: WhenTrue, otherwise: WhenFalse) => Operation<ValueOrResultOfExpression<WhenTrue> | ValueOrResultOfExpression<WhenFalse>>;
