...
export declare type SendRequestParams<SuccessResponse = any, ErrorResponse = any> = (ActionProps<BaseSendRequestParams & EnhancedSendRequestParams<SuccessResponse, ErrorResponse>>);
/**
 ...
 */
export declare function sendRequest<SuccessResponse = any, ErrorResponse = any>({ onError, onSuccess, ...other }: SendRequestParams<SuccessResponse, ErrorResponse>): import("../model/action").Action<any>;
interface ComposeRequest<SuccessResponse = any, ErrorResponse = any> {
    <Options extends object, Curried extends Partial<SendRequestParams<SuccessResponse, ErrorResponse>>>(fn: (options: Options) => Curried): ((options: Options & Omit<SendRequestParams<SuccessResponse, ErrorResponse>, keyof Curried>) => ReturnType<typeof sendRequest>);
}
/**
 ...
 */
export declare function request<SuccessResponse = any, ErrorResponse = any>(): {
    /**
     ...
     */
    compose: ComposeRequest<SuccessResponse, ErrorResponse>;
};
export {};
