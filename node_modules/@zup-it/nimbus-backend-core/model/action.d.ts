...
*/
export declare type ActionProps<Props> = Props;
/**
 * An Action factory.
 */
export declare type ActionFunction<Props> = (props: ActionProps<Props>) => Action;
export declare type Actions = Action | Action[];
/**
...
export declare class Action<Props = any> {
    ...
    static isAction(value: any | undefined | null): boolean;
}
/**
