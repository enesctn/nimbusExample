import { NimbusHeaders } from './types';
/**
 ...
 */
export declare function isWeb(headers: NimbusHeaders): boolean;
/**
 ...
 */
export declare function isMobile(headers: NimbusHeaders): boolean;
