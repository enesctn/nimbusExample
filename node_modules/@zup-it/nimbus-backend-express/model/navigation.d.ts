...
declare type Push<T extends ScreenRequest> = ScreenNavigation<T>;
declare type Present<T extends ScreenRequest> = ScreenNavigation<T>;
declare type PopTo<T extends ScreenRequest> = Pick<ScreenNavigation<T>, 'routeParams' | 'query'>;
declare type NavigationAction<T extends ScreenRequest, N, OP = false> = HasRequiredProperty<OP extends true ? Omit<T, 'params'> : T> extends true ? [screen: Screen<T>, properties: N] : [screen: Screen<T>, properties?: N];
