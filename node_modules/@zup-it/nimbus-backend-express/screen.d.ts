...
export interface RequestWithCustomHeaders<RouteParams = any, Headers = any, Data = any, Query = any> extends Request<RouteParams, any, Data, Query> {
    /**
 ...
 * navigation state.
 */
export declare type Screen<T extends ScreenRequest = ScreenRequest> = (props: ScreenProps<T>) => JSX.Element;
 ...
 */
export declare type ScreenNavigation<T extends ScreenRequest> = BaseScreenNavigation & (IsRequired<T, 'routeParams'> extends true ? WithRouteParams<T['routeParams']> : Partial<WithRouteParams<T['routeParams']>>) & (IsRequired<T, 'headers'> extends true ? WithHeaders<T['headers']> : Partial<WithHeaders<T['headers']>>) & (IsRequired<T, 'data'> extends true ? WithData<T['data']> : Partial<WithData<T['data']>>) & (IsRequired<T, 'query'> extends true ? WithQuery<T['query']> : Partial<WithQuery<T['query']>>) & WithEvents<T['events']> & (IsRequired<T, 'state'> extends true ? WithState<T['state']> : Partial<WithState<T['state']>>);
export {};
